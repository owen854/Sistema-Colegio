...
class FormLoginDesigner():
    ...
    def __init__(self):
        ...
        logo = utl.leer_imagen("./imagenes/logou.png", (200, 200))
        # frame_logo
        frame_logo = tk.Frame(self.ventana, bd=0, width=300,
                              relief=tk.SOLID, padx=10, pady=10, bg='#ad3333')
        frame_logo.pack(side="left", expand=tk.YES, fill=tk.BOTH)
        label = tk.Label(frame_logo, image=logo, bg='#ad3333')
        ...
        inicio = tk.Button(frame_form_fill, text="Iniciar sesion", font=(
            'Times', 15), bg='#ad3333', bd=0, fg="#fff", command=self.verificar)
